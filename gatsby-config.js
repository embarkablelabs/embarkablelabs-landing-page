...
module.exports = {
	siteMetadata: {
		...
		url: 'https://embarkable.io',
		siteUrl: `https://embarkable.io`,
		author: `Embarkable LLC`,
	...
	plugins: [
		...
		},
		{
			...
			options: {
			  ...
			  host: 'embarkable.io', // if 'www' is set to 'false', be sure to also remove it here!
			  ErrorDocument: `
		...
		},
		{
			...
			options: {
			  src: '/crisp-script.js' // Change to the script filename
			}
		},
